...
struct ContentView: View {
    @ObservedObject var UserData:ToDo = ToDo(data: [SingleToDo(title: "吃饭", duedate: Date()),
...
//    var duedate:Date = Date()
    ...
    var body:some View{
        HStack{
            Rectangle().frame(width: 6).foregroundColor(/*@START_MENU_TOKEN@*/.blue/*@END_MENU_TOKEN@*/)
